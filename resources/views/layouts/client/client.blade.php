...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('cowell/client/css/font-awesome.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('cowell/client/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('cowell/client/css/owl.theme.default.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('cowell/client/css/aos.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('cowell/client/css/jquery-ui.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('cowell/client/css/style.css')}}">
    @yield('css')
</head>
...
<body>
    ...
    <script src="{{asset('cowell/client/js/jquery-1.9.1.js')}}"></script>
    <script src="{{asset('cowell/client/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('cowell/client/js/jquery-scrolltofixed-min.js')}}"></script>
    <script src="{{asset('cowell/client/js/owl.carousel.min.js')}}"></script>
    <script src="{{asset('cowell/client/js/jquery.marquee.min.js')}}"></script>
    <script src="{{asset('cowell/client/js/sweet.alert.min.js')}}"></script>
    <script src="{{asset('cowell/client/js/clamp.min.js')}}"></script>
    <script src="{{asset('cowell/client/js/jquery-ui.min.js')}}"></script>
    <script src="{{asset('cowell/client/js/aos.js')}}"></script>
    <script src="{{asset('cowell/client/js/custom.js')}}"></script>
