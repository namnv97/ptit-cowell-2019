        ...
        <div class="why_choose">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="item">
                        <img src="{{asset($arr['img'])}}?v=4.0.1" alt="img">
                        <div class="text">
                            {!! $arr['content'] !!}
                        </div>
                    </div>
...
<div class="container">
                ...
                <div class="box-item">
                    <div class="box-img">
                        <a href="{{route('client.product',['slug'=>$product->slug])}}">
                            <img src="{{asset($product->image)}}?v=4.0.1" alt="{{$product->name}}" width="100%" />
    ...
    <div class="category_list aos" data-aos="{{($key%2 == 0)?'fade-left':'fade-right'}}" data-duration='2500'>
        ...
        <div class="owl-carousel product_by_cat">
            ...
            <div class="item">
                <a href="{{route('client.product',['slug' => $product->slug])}}">
                    <img src="{{asset($product->image)}}?v=4.0.1" alt="{{$product->name}}">
                    <!-- <span class="sale_img">-10%</span> -->
                </a>
